...
namespace API_Course.Migrations
{
    ...
    [Migration("20201123001332_FightProps")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Course.Models.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API_Course.Models.WeaponModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API_Course.Models.CharacterSkill", b =>
                {
                    ...
                    b.HasOne("API_Course.Models.Skill", "Skill")
                        .WithMany("CharacterSkills")
            ...
            modelBuilder.Entity("API_Course.Models.WeaponModel", b =>
                {
                    b.HasOne("API_Course.Models.Character", "Character")
                        .WithOne("Weapon")
                        .HasForeignKey("API_Course.Models.WeaponModel", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
